                ...
                <section className="flex h-full w-[470px] flex-col items-center justify-center">
                    <a
                        ...
                        <img
                            ...
                            data-nimg="1"
                            className="logo m-auto mb-6 mt-4 w-[180px]" src="/images/login-logo.svg"
                        />
                    </a>
                    <section className="flex w-[310px]  overflow-hidden">
                        ...
                        >
                            <section
                                ...
                                className="mb-[20px] text-[30px] font-semibold text-primary text-center">خوش آمدید!</h2>
                                <section className="mb-[9px] flex gap-1 justify-center"><span
                                    className="title ">ورود</span><span>|</span> <span>ثبت نام</span></section>
                                <form
                                    className="mx-auto mb-8 flex w-[90%] max-w-full flex-col items-start md:w-full xl:mb-[181px] xl:w-[280px]">
                                    <h2 className="title w-full mb-[35px] text-center">لطفا شماره موبایل خود را وارد
                                        کنید</h2>
                                    ...
                                    <button type="submit"
                                            className="relative flex h-12 false items-center justify-center rounded-[10px] bg-primary text-black px-5 transition-all duration-700 disabled:opacity-50 w-full mt-7 hover:shadow-2xl focus:shadow-none">تایید
                                        و دریافت کد
                                        <div className="btnLoader  opacity-0">
                                            <div></div>
                                            <div></div>
                                            <div></div>
                                            <div></div>
